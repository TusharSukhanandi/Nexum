  ...
  return (
    <>
      ...
      <div className="text-center w-[90%] m-auto bg-[#c7b293] rounded-lg flex justify-start items-center gap-4 h-20 sm:h-16 text-xl mt-2 hover:bg-[#a39277] sm:cursor-pointer duration-500 transition-all "> 
        <div className="animate-fadeIn rounded-full border-x-2 border-y-2 border-white w-10 h-10 ml-5 transition-all duration-200">
          <img className="w-full h-full object-cover rounded-full" src={conversation.profilePicture} alt="profilePicture" />
          {isOnline && isOnline ? (
