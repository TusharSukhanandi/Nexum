...
const Home = () => {
  return (
    <div className="w-full font-mukta h-dvh bg-[linear-gradient(_purple_0%,_black_30%,black_75%,_purple_100%)]">
      ...
      <main className="  animate-fadeIn  w-full h-[50dvh] md:h-[60dvh] flex flex-col md:flex-row justify-center items-center relative">
        ...
        <div className="z-20 flex items-center justify-center gap-2 flex-col ">
          <h6 className="text-white text-2xl">
            Connect any where in the world
          </h6>
          <h1 className="text-white text-2xl">in real-time with</h1>
          <h1 className="text-purple-800 mt-2 font-lobster text-6xl">Nexum</h1>
          <button className="transition duration-1000 text-white text-lg px-4 py-3 mt-6 border-2  font-medium border-purple-800 rounded-2xl hover:text-purple-950 hover:bg-white hover:border-white active:-scale-90">
            Get started
          </button>
        </div>
      </main>
